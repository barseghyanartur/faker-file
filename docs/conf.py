...
html_css_files = [
    ...
    "https://cdn.jsdelivr.net/gh/barseghyanartur/prismjs-sphinx@latest/src/css/sphinx_rtd_theme.css",
]
...
html_js_files = [
    ...
    "https://cdn.jsdelivr.net/gh/barseghyanartur/prismjs-sphinx@latest/src/js/download_adapter.js",
]
