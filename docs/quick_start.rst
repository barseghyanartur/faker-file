...
.. literalinclude:: _static/examples/quick_start/factory_import_and_init_1.py
    :language: python
    :lines: 3, 5-45, 49-78
    :name: test_factory_import_and_init_1
...
.. literalinclude:: _static/examples/quick_start/factory_import_and_init_1.py
    ...
    :name: test_factory_import_and_init_2
...
.. container:: jsphinx-download
    ...
    .. literalinclude:: _static/examples/quick_start/factory_import_and_init_1.py
        :language: python
        :lines: 122-
        :name: test_factory_import_and_init_3
