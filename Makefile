...
# Usage: make docker-test ENV=py312-django42-pathy0110
...
# Usage: make docker-shell-env ENV=py312-django42-pathy0110
docker-shell-env: docker-build
        @if [ -z "$(ENV)" ]; then \
                echo "Usage: make docker-shell-env ENV=py312-django42-pathy0110"; \
                exit 1; \
        fi
